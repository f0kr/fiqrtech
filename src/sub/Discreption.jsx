...
export default function Discreption() {
    ...
    return (
        ...
        <div className={styles.depart_container}>
            <div className={ faceNumber === 1? styles.department: styles.transition}>Programming</div>
