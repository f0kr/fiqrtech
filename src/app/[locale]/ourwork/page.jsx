      ...
      <div className="footer-container">
        ...
        <div className="cta-container">
          ...
          <div className="cta-buttons">
            <a href="/order" className="cta-button primary">Start a Project</a>
      ...
      <main className="main-content">
        ...
        <section className="page-header">
          ...
          <p className="page-description">
            Discover our innovative projects and success stories. We combine
            cutting-edge technology with creative solutions to solve complex
            problems.
          </p>
        </section>
