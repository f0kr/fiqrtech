...
const grassAlbedo = textureLoader.load('/whispy-grass-meadow-bl/wispy-grass-meadow_albedo.png')
grassAlbedo.colorSpace = THREE.SRGBColorSpace
const grassAo = textureLoader.load('/whispy-grass-meadow-bl/wispy-grass-meadow_ao.png')
const grassHeight = textureLoader.load('/whispy-grass-meadow-bl/wispy-grass-meadow_height.png')
const grassMetallic = textureLoader.load('/whispy-grass-meadow-bl/wispy-grass-meadow_metallic.png')
const grassNormal = textureLoader.load('/whispy-grass-meadow-bl/wispy-grass-meadow_normal-ogl.png')
const grassRoughness = textureLoader.load('/whispy-grass-meadow-bl/wispy-grass-meadow_roughness.png')

// load the boulder textures
const boulderAlbedo = textureLoader.load('/badlands-boulders-bl/badlands-boulders_albedo.png')
boulderAlbedo.colorSpace = THREE.SRGBColorSpace
const boulderAo = textureLoader.load('/badlands-boulders-bl/badlands-boulders_ao.png')
const boulderHeight = textureLoader.load('/badlands-boulders-bl/badlands-boulders_height.png')
const boulderMetallic = textureLoader.load('/badlands-boulders-bl/badlands-boulders_metallic.png')
const boulderNormal = textureLoader.load('/badlands-boulders-bl/badlands-boulders_normal-ogl.png')
const boulderRoughness = textureLoader.load('/badlands-boulders-bl/badlands-boulders_roughness.png')

// load the space cruiser textures
const spaceCruiserAlbedo = textureLoader.load('/space-cruiser-panels2-bl/space-cruiser-panels2_albedo.png')
spaceCruiserAlbedo.colorSpace = THREE.SRGBColorSpace
const spaceCruiserAo = textureLoader.load('/space-cruiser-panels2-bl/space-cruiser-panels2_ao.png')
const spaceCruiserHeight = textureLoader.load('/space-cruiser-panels2-bl/space-cruiser-panels2_height.png')
const spaceCruiserMetallic = textureLoader.load('/space-cruiser-panels2-bl/space-cruiser-panels2_metallic.png')
const spaceCruiserNormal = textureLoader.load('/space-cruiser-panels2-bl/space-cruiser-panels2_normal-ogl.png')
const spaceCruiserRoughness = textureLoader.load('/space-cruiser-panels2-bl/space-cruiser-panels2_roughness.png')
